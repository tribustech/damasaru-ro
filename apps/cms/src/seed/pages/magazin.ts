  ...
  await upsertSingleType(strapi, 'api::magazin-page.magazin-page', {
    ...
    sections: [
      ...
      // Zone 2 — Cărți: 3 carduri (paper) — cards-grid `products` variant
      {
        ...
        variant: 'products',
        items: [
          // Card 1 — Carte fizică (disponibilă pe Bookzone)
          {
            title: 'Creierul este superputerea ta',
            format: 'hardcover',
            eyebrow: 'Carte tipărită · 224 pagini',
            tag: 'Fizic',
            iconImage: bookCover,
            text: 'Cartea care explică, în limbaj accesibil, cum funcționează creierul tău și ce poți face concret ca să-l antrenezi. Bestseller Bookzone 2024.',
            metaItems: [
              { icon: '📖', label: '224 pagini' },
              { icon: '🗓', label: 'Publicată noiembrie 2024' },
              { icon: '🏢', label: 'Editura Bookzone' },
            ],
            price: '89 lei',
            ctaLabel: 'Cumpără pe Bookzone',
            fineprint: 'Livrare prin Bookzone — 1–3 zile lucrătoare în România.',
          ...
          // Card 2 — E-book (în curând, listă de așteptare)
          {
            title: 'Creierul este superputerea ta',
            format: 'ebook',
            eyebrow: 'E-book · PDF + EPUB',
            tag: 'În curând',
            iconImage: bookCover,
            text: 'Aceeași carte, în format digital. Download instant după plată, în PDF + EPUB. Citește pe orice device — laptop, tabletă, Kindle, telefon.',
            metaItems: [
              { icon: '📱', label: 'PDF + EPUB' },
              { icon: '⚡', label: 'Download instant' },
              { icon: '📖', label: 'Compatibil Kindle, Apple Books' },
            ],
            priceText: 'Disponibil în curând',
            ctaLabel: 'Anunță-mă când apare',
            fineprint: 'Primești un singur email — când lansez e-book-ul. Fără spam între timp.',
            // Waitlist CTAs reuse the newsletter form at the bottom of the page.
            href: '#newsletter',
          },
          // Card 3 — Audiobook (în curând, listă de așteptare)
          {
            title: 'Creierul este superputerea ta',
            format: 'audiobook',
            eyebrow: 'Audiobook · înregistrat de Costin',
            ...
            metaItems: [
              { icon: '🎧', label: 'Audio MP3 + streaming' },
              { icon: '🎙', label: 'Înregistrat personal de Costin' },
              { icon: '⏱', label: 'Durată estimată: ~8 ore' },
              { icon: '📅', label: 'Lansare: toamna 2026' },
            ],
